<template>
  <div class="App">
    ...
    <div class="Modal" v-if="state.selectedImage" @click="모달_닫기">
...
onUnmounted(() => {
  window.removeEventListenerEventListener("keydown", 백스페이스누르면_뒤로가줘)
  window.removeEventListener("keydown", Escape누르먼_뒤로가줘)
})
